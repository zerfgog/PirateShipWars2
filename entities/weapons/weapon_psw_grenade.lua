...
if CLIENT then
	...
	killicon.Add("weapon_psw_grenade", "hud/keg", color_white)
...
function SWEP:PreDrop()
	-- if owner dies or drops us while the pin has been pulled, create the armed grenade anyway
	if self:GetPin() then
		self:BlowInFace()
	end
end
...
function SWEP:CanPrimaryAttack()
	return self.Owner:WaterLevel() > 0
end